...
<form method="get" action="<?php echo home_url(); ?>" id="search-blog">
    <div class="input-group">
        <input class="form-control" type="text" type="search" name="s" placeholder="<?php _e('buscar notícias', 'mobu_theme'); ?>" aria-label="<?php _e('busca notícias', 'mobu_theme'); ?>" aria-describedby="button-search" />
