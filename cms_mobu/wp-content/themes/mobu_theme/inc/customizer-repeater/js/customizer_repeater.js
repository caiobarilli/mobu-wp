...
function customizer_repeater_refresh_social_icons(th) {
  ...
  th.find('.customizer-repeater-social-repeater-container').each(function () {
    ...
    var link = jQuery(this)
      .find('.customizer-repeater-social-repeater-link')
      .val()
  ...
  th.find('.social-repeater-socials-repeater-colector').val(
    JSON.stringify(icons_repeater_values),
  )
    ...
    th.find('.customizer-repeater-general-control-repeater-container').each(
      function () {
        ...
        var text2 = jQuery(this)
          .find('.customizer-repeater-text2-control')
          .val()
        var link2 = jQuery(this)
          .find('.customizer-repeater-link2-control')
          .val()
        var color = jQuery(this)
          .find('input.customizer-repeater-color-control')
          .val()
        var color2 = jQuery(this)
          .find('input.customizer-repeater-color2-control')
          .val()
        var image_url = jQuery(this).find('.custom-media-url').val()
        var choice = jQuery(this)
          .find('.customizer-repeater-image-choice')
          .val()
        var title = jQuery(this)
          .find('.customizer-repeater-title-control')
          .val()
        var subtitle = jQuery(this)
          .find('.customizer-repeater-subtitle-control')
          .val()
        ...
        var social_repeater = jQuery(this)
          .find('.social-repeater-socials-repeater-colector')
          .val()
        var shortcode = jQuery(this)
          .find('.customizer-repeater-shortcode-control')
          .val()
...
jQuery(document).ready(function () {
  ...
  theme_conrols.on('change', '.customizer-repeater-image-choice', function () {
    if (jQuery(this).val() === 'customizer_repeater_image') {
      jQuery(this)
        .parent()
        .parent()
        .find('.social-repeater-general-control-icon')
        .hide()
      jQuery(this)
        .parent()
        .parent()
        .find('.customizer-repeater-image-control')
        .show()
      jQuery(this)
        .parent()
        .parent()
        .find('.customizer-repeater-color-control')
        .prev()
        .prev()
        .hide()
      jQuery(this)
  ...
  theme_conrols.on('click', '.customizer-repeater-new-field', function () {
    ...
    if (typeof th !== 'undefined') {
      /* Clone the first box*/
      var field = th
        .find('.customizer-repeater-general-control-repeater-container:first')
        .clone(true, true)
      ...
      if (typeof field !== 'undefined') {
        ...
        field
          .find('.customizer-repeater-social-repeater')
          .find('.customizer-repeater-social-repeater-container')
          .not(':first')
          .remove()
        ...
        field
          .find('div.customizer-repeater-color-control .wp-picker-container')
          .replaceWith(
            '<input type="text" class="customizer-repeater-color-control ' +
              id +
              '">',
          )
        field
        ...
        field
          .find('div.customizer-repeater-color2-control .wp-picker-container')
          .replaceWith(
            '<input type="text" class="customizer-repeater-color2-control ' +
              id +
              '">',
          )
        field
        ...
        /*Append new box*/
        th.find('.customizer-repeater-general-control-repeater-container:first')
          .parent()
          .append(field)
  ...
  jQuery('input.customizer-repeater-color2-control').wpColorPicker(
    color_options,
  )
  ...
  theme_conrols.on(
    ...
    function (event) {
      ...
      var th = jQuery(this).parent()
      var id =
        'customizer-repeater-social-repeater-' + customizer_repeater_uniqid()
      if (typeof th !== 'undefined') {
        var field = th
          .find('.customizer-repeater-social-repeater-container:first')
          .clone(true, true)
        if (typeof field !== 'undefined') {
          field.find('.icp').val('')
          field.find('.input-group-addon').find('.fa').attr('class', 'fa')
          ...
          th.find('.customizer-repeater-social-repeater-container:first')
            .parent()
            .append(field)
        }
      }
